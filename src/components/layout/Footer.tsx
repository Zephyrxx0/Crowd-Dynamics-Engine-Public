...
export function Footer() {
  return (
    <footer className="w-full bg-[#111111] dark:bg-[#e3d5ca] text-[#e3d5ca] dark:text-[#111111] py-24 mt-auto relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-10">
          <span
            className="text-[12rem] sm:text-15xl font-bold tracking-tight text-[#e3d5ca] dark:text-[#111111]"
