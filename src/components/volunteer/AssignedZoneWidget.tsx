...
export function AssignedZoneWidget({ zoneId }: AssignedZoneWidgetProps) {
  ...
  const zoneData = useMemo(() => {
    ...
    return latestSimulationOutput.phaseZoneMatrix.find((z) => z.zoneId === zoneId) || null;
  ...
  return (
    <div className="bg-card border border-border p-5 rounded-xl shadow-sm space-y-4">
      <div className="flex justify-between items-start">
        <div>
          <h3 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Assigned Zone</h3>
